        ...
        <div class="cwp4-text col-xl-6 ">
          <div class="posivtion-grid">
            ...
            <div class="hair-two-colums">
              <div class="hair-left"><h5>Waxing</h5></div>
              <div class="hair-left"><h5>Facial</h5></div>
              <div class="hair-left"><h5>Hair makeup</h5></div>
              <div class="hair-left"><h5>Massage</h5></div>
              <div class="hair-left"><h5>Menicure</h5></div>
              <div class="hair-left"><h5>Pedicure</h5></div>
              <div class="hair-left"><h5>Hair Cut</h5></div>
              <div class="hair-left"><h5>Body Spa</h5></div>
            </div>
          </div>
        </div>
      </div>
      ...
      <div class="row">
        <div class="my-bio col-lg-6">
          <div class="hair-make">
            ...
            ?>
              <h5><a href="blog.html"><?php echo htmlspecialchars($row['PageTitle']); ?></a></h5>
              <p class="para mt-2"><?php echo nl2br(htmlspecialchars($row['PageDescription'])); ?></p>
            <?php } ?>
          </div>
        </div>
        <div class="col-lg-6 ">
